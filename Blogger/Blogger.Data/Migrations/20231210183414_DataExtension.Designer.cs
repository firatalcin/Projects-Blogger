...
namespace Blogger.Data.Migrations
{
    ...
    [Migration("20231210183414_DataExtension")]
            ...
            modelBuilder.Entity("Blogger.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab059ad4-dac9-4aa3-b85a-53d215397ff1"),
                            ...
                            CreatedDate = new DateTime(2023, 12, 10, 21, 34, 13, 948, DateTimeKind.Local).AddTicks(4968),
                        ...
                        new
                        {
                            Id = new Guid("b4bfe9ac-b648-447b-a84d-2e1ac430dd98"),
                            ...
                            CreatedBy = "Admin test",
                            CreatedDate = new DateTime(2023, 12, 10, 21, 34, 13, 948, DateTimeKind.Local).AddTicks(4973),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Blogger.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 10, 21, 34, 13, 948, DateTimeKind.Local).AddTicks(5829),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Asp.Net Core"
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 10, 21, 34, 13, 948, DateTimeKind.Local).AddTicks(5832),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Visual Studio"
            ...
            modelBuilder.Entity("Blogger.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin test",
                            CreatedDate = new DateTime(2023, 12, 10, 21, 34, 13, 948, DateTimeKind.Local).AddTicks(6397),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin test",
                            CreatedDate = new DateTime(2023, 12, 10, 21, 34, 13, 948, DateTimeKind.Local).AddTicks(6407),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
